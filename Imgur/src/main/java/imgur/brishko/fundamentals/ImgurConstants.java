...
/**
 * Created by bri6ko on 2/3/14.
 */
public class ImgurConstants {
    public static final String IMGUR_CLIENT_ID = "44359ddf27ba3dc";
    public static final String IMGUR_CLIENT_SECRET = "6e5cbfcb596909d1934dc90dd0ba832f245d8d1e";
    public static final String IMGUR_REDIRECT_URL = "brisko://igor";
    public static final String IMGUR_ACCESS_TOKEN = "access_token";
    public static final String IMGUR_REFRESH_TOKEN = "refresh_token";
    public static final String IMGUR_EXPIRES_IN = "expires_in";
